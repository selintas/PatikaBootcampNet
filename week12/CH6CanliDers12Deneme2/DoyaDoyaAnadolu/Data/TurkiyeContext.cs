...
namespace DoyaDoyaAnadolu.Data
{
    public class TurkiyeContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<Bolge>().HasData(BolgeleriGetir());
            modelBuilder.Entity<Sehir>().HasData(SehirleriGetir());
        }

        private Bolge[] BolgeleriGetir()
        {
            return new Bolge[]
            {
